...
class Constants{
     ...
     **/
    static let googleBooksAPIKey = SaveData().getGoogleAPIKey() ?? "AIzaSyC6ln3IGpVEQYQs0kxDbKYgil_Ql6aSEVQ"
    static let generateAIKey = SaveData().getGenerativeAPIKey() ?? "AIzaSyC4xsEGffooVm5FyjJhM5fcshJipiTVf0A"
